<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:75:"D:\wamp64\www\property\public/../application/admin\view\department\lst.html";i:1528373728;s:61:"D:\wamp64\www\property\application\admin\view\public\top.html";i:1527944631;s:62:"D:\wamp64\www\property\application\admin\view\public\left.html";i:1528374126;}*/ ?>
<!doctype html>
<html>
                        ...
                        <div class="am-u-sm-12 am-u-md-6">
                            <div class="am-btn-toolbar">
                                <div class="am-btn-group am-btn-group-xs">
                                    <a href="/property/public/admin/department/add.html" class="am-btn am-btn-default am-btn-success"><span class="am-icon-plus"></span> 新增</a>
                                ...
                                <table class="am-table am-table-striped am-table-hover table-main">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="table-author am-hide-sm-only">部门电话</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $vo['bn_id']; ?></td>
                                            <td><?php echo $vo['bn_name']; ?></td>
                                            <td><?php echo $vo['gl_name']; ?></td>
                                            <td class="am-hide-sm-only"><?php echo $vo['bn_phone']; ?></td>
                                            <td><?php echo $vo['bn_note']; ?></td>
                                            <td class="am-hide-sm-only"><?php echo date("Y-m-d",$vo['time']); ?></td>
                                            <td>
                                          
                                                <div class="am-btn-toolbar">
                                                    <div class="am-btn-group am-btn-group-xs">
                                                        <a  href="<?php echo url('edit',array('id'=>$vo['bn_id'])); ?>"  class="am-btn am-btn-default am-btn-xs am-hide-sm-only"><span class="am-icon-copy"></span> 编辑</a>
                                                        <a  href="<?php echo url('del',array('id'=>$vo['bn_id'])); ?>"  class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only"><span class="am-icon-trash-o"></span> 删除</a>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
