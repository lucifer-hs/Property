<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:76:"D:\wamp64\www\property\public/../application/admin\view\information\see.html";i:1528261982;s:61:"D:\wamp64\www\property\application\admin\view\public\top.html";i:1527944631;s:62:"D:\wamp64\www\property\application\admin\view\public\left.html";i:1528281665;}*/ ?>
<!doctype html>
<html>
 ...
 <div class="tpl-left-nav tpl-left-nav-hover">
        ...
        <div class="tpl-content-wrapper">
            ...
            <ol class="am-breadcrumb">
                ...
                <li class="am-active">业主信息修改表单</li>
            </ol>
                            ...
                            <form class="am-form am-form-horizontal" action="" method="post" enctype="multipart/form-data">
                                 ...
                                 <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        ...
                                        <select  data-am-selected="{searchBox: 1,maxHeight:250}" name="home_number_1" disabled="true" >
                                           <option value="<?php echo $list['fw_number']['0']; ?>"><?php echo $list['fw_number']['0']; ?></option>
                                                           
                                        </select>
                                      <select  data-am-selected="{searchBox: 1,maxHeight:250}" name="home_number_2" disabled="true" >
                                            <option value="<?php echo $list['fw_number']['1']; ?>"><?php echo $list['fw_number']['1']; ?></option>
                                            
                                        </select>
                                         <select  data-am-selected="{searchBox: 1,maxHeight:250}" name="home_number_3" disabled="true" >
                                            <option value="<?php echo $list['fw_number']['2']; ?>"><?php echo $list['fw_number']['2']; ?></option>
                                    ...
                                    <div class="am-u-sm-9">
                                        <select data-am-selected="{searchBox: 1}"name="home_style" disabled="true" >
                                      <option value="<?php echo $list['fw_style']; ?>"><?php echo $list['fw_style']; ?></option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <input type="text" id="user-name"name="home_name" placeholder="业主 / Name" value="<?php echo $list['yz_name']; ?>" disabled="true" >
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <input type="text" id="user-email" name="home_data" placeholder="合同资料编号 / Data" value="<?php echo $list['fw_detailed']; ?>" disabled="true" >
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <select data-am-selected="{searchBox: 1,maxHeight:250} " name="home_date_y" disabled="true" >
                                              <option value="<?php echo $list['gf_date']['0']; ?>"><?php echo $list['gf_date']['0']; ?></option>
                                            </select>年
                                           <select data-am-selected="{searchBox: 1,maxHeight:250} " name="home_date_m" disabled="true" >
                                              <option value="<?php echo $list['gf_date']['1']; ?>"><?php echo $list['gf_date']['1']; ?></option>
                                            </select>月
                                          <select data-am-selected="{searchBox: 1,maxHeight:250}" name="home_date_d" disabled="true" >
                                              <option value="<?php echo $list['gf_date']['2']; ?>"><?php echo $list['gf_date']['2']; ?></option>
                                            </select>日
                                </div>
                                <div class="am-form-group">
                                    <label for="user-phone" class="am-u-sm-3 am-form-label">电话 / Telephone</label>
                                    <div class="am-u-sm-9">
                                        <input type="tel"  name="home_phone"  placeholder="输入你的电话号码 / Telephone" disabled="true" value="<?php echo $list['yz_phone']; ?>">
                                    </div>
                                </div>
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <select data-am-selected="{searchBox: 1}" name="home_state" disabled="true" >
                                      <option value="<?php echo $list['fw_state']; ?>"><?php echo $list['fw_state']; ?></option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="am-form-group">
                                   <label for="user-weibo" class="am-u-sm-3 am-form-label">备注 / Note</label>
                                    <div class="am-u-sm-9">
                                        <textarea class="" rows="5" id="user-intro" name="home_note"  placeholder="输入你的备注 /  Note  "  readonly="readonly" > <?php echo $list['fw_note']; ?></textarea>
                                 ...
                                 <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                       <?php echo $list['yz_fjs']; ?>
                                    </div>
                                </div>
                                <div class="am-form-group">
                                    <div class="am-u-sm-9 am-u-sm-push-3">
                                         <input class="am-btn am-btn-primary" onclick="history.go(-1)" value="返回" type="button">
                                    </div>
                                </div>
