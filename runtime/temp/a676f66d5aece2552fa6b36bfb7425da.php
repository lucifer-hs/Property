<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:77:"D:\wamp64\www\property\public/../application/admin\view\information\edit.html";i:1528273859;s:61:"D:\wamp64\www\property\application\admin\view\public\top.html";i:1527944631;s:62:"D:\wamp64\www\property\application\admin\view\public\left.html";i:1528281665;}*/ ?>
<!doctype html>
<html>
                           ...
                           <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        ...
                                        <select  data-am-selected="{searchBox: 1,maxHeight:250}" name="home_number_1" disabled="true" >
                                           <option value="<?php echo $lst['fw_number']['0']; ?>"><?php echo $lst['fw_number']['0']; ?></option>
                                                           
                                        </select>
                                      <select  data-am-selected="{searchBox: 1,maxHeight:250}" name="home_number_2" disabled="true" >
                                            <option value="<?php echo $lst['fw_number']['1']; ?>"><?php echo $lst['fw_number']['1']; ?></option>
                                            
                                        </select>
                                         <select  data-am-selected="{searchBox: 1,maxHeight:250}" name="home_number_3" disabled="true" >
                                            <option value="<?php echo $lst['fw_number']['2']; ?>"><?php echo $lst['fw_number']['2']; ?></option>
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <input type="text" id="user-name"name="home_name" placeholder="业主 / Name" value="<?php echo $lst['yz_name']; ?>" >
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <input type="text" id="user-email" name="home_data" placeholder="合同资料编号 / Data" value="<?php echo $lst['fw_detailed']; ?>" >
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <select data-am-selected="{searchBox: 1,maxHeight:250} " name="home_date_y" disabled="true" >
                                              <option value="<?php echo $lst['gf_date']['0']; ?>"><?php echo $lst['gf_date']['0']; ?></option>
                                            </select>年
                                           <select data-am-selected="{searchBox: 1,maxHeight:250} " name="home_date_m" disabled="true" >
                                              <option value="<?php echo $lst['gf_date']['1']; ?>"><?php echo $lst['gf_date']['1']; ?></option>
                                            </select>月
                                          <select data-am-selected="{searchBox: 1,maxHeight:250}" name="home_date_d" disabled="true" >
                                              <option value="<?php echo $lst['gf_date']['2']; ?>"><?php echo $lst['gf_date']['2']; ?></option>
                                            </select>日
                                    </div>
                                 </div>  
                            <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <input type="tel"  name="home_phone"  placeholder="输入你的电话号码 / Telephone" value="<?php echo $lst['yz_phone']; ?>" >
                                    </div>
                                </div>
                                ...
                                <div class="am-form-group">
                                   <label for="user-weibo" class="am-u-sm-3 am-form-label">备注 / Note</label>
                                    <div class="am-u-sm-9">
                                        <textarea class="" rows="5" id="user-intro" name="home_note"  placeholder="输入你的备注 /  Note"> <?php echo $lst['fw_note']; ?></textarea>
                                 ...
                                 <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <input type="file" name="file" placeholder="添加附件 / Telephone"> <?php if($lst['yz_fjs'] == ''): ?>
                                                    暂无附件
                                                    <?php else: ?>
                                                    <?php echo $lst['yz_fjs']; endif; ?>
                                    </div>
                                </div>
                                <div class="am-form-group">
