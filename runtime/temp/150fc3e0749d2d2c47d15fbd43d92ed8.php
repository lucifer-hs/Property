<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:72:"D:\wamp64\www\property\public/../application/admin\view\login\login.html";i:1527941320;}*/ ?>
<!doctype html>
<html>
		...
		<div class="am-u-sm-10 login-am-center">
			<form class="am-form" action="" method="post">
				<fieldset>
					...
					<div class="am-form-group">
						<input type="password" name="password" class="" id="doc-ipt-pwd-1" placeholder="输个密码吧">
					</div>
					<p><button type="submit" value="登录" class="am-btn am-btn-default">登录</button></p>
				</fieldset>
			</form>
		</div>
	</div>
