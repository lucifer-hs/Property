<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:76:"D:\wamp64\www\property\public/../application/admin\view\information\lst.html";i:1528362712;s:61:"D:\wamp64\www\property\application\admin\view\public\top.html";i:1527944631;s:62:"D:\wamp64\www\property\application\admin\view\public\left.html";i:1528374126;}*/ ?>
<!doctype html>
<html>
                    ...
                    <div class="am-g">
                        <div class="am-u-sm-12 am-u-md-6">
                            <div class="am-btn-toolbar">
                                <div class="am-btn-group am-btn-group-xs">
                                    <a href="/property/public/admin/information/add.html" class="am-btn am-btn-default am-btn-success"><span class="am-icon-plus"></span> 新增</a>
                        ...
                        <div class="am-u-sm-12 am-u-md-3">
                            <div class="am-form-group">
                                <select data-am-selected="{btnSize: 'sm'}"name="style" >
                                ...
                                <table class="am-table am-table-striped am-table-hover table-main">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="table-author am-hide-sm-only">业主</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $vo['ww_id']; ?></td>
                                            <td><?php echo $vo['fw_number']; ?></td>
                                            <td><?php echo $vo['fw_style']; ?></td>
                                            <td class="am-hide-sm-only"><?php echo $vo['yz_name']; ?></td>
                                            <td><?php echo $vo['yz_phone']; ?></td>
                                             <td><?php echo $vo['fw_state']; ?></td>
                                            <td class="am-hide-sm-only"><?php echo date("Y-m-d",$vo['time']); ?></td>
                                            <td>
                                          
                                                <div class="am-btn-toolbar">
                                                    <div class="am-btn-group am-btn-group-xs">
                                                        <a  href="<?php echo url('see',array('id'=>$vo['ww_id'])); ?>" class="am-btn am-btn-default am-btn-xs am-text-secondary"><span class="am-icon-pencil-square-o"></span> 查看</a>
                                                        <a  href="<?php echo url('edit',array('id'=>$vo['ww_id'])); ?>"  class="am-btn am-btn-default am-btn-xs am-hide-sm-only"><span class="am-icon-copy"></span> 编辑</a>
                                                        <a  href="<?php echo url('del',array('id'=>$vo['ww_id'])); ?>"  class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only"><span class="am-icon-trash-o"></span> 删除</a>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
