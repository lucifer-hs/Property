<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:76:"D:\wamp64\www\property\public/../application/admin\view\department\edit.html";i:1528373642;s:61:"D:\wamp64\www\property\application\admin\view\public\top.html";i:1527944631;s:62:"D:\wamp64\www\property\application\admin\view\public\left.html";i:1528374126;}*/ ?>
<!doctype html>
<html>
 ...
 <div class="tpl-left-nav tpl-left-nav-hover">
        ...
        <div class="tpl-content-wrapper">
            ...
            <ol class="am-breadcrumb">
                ...
                <li class="am-active">部门信息添加表单</li>
            </ol>
                        ...
                        <div class="am-u-sm-12 am-u-md-9">
                            <form class="am-form am-form-horizontal" action="" method="post" enctype="multipart/form-data">
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <input type="text" id="user-name"name="bn_name" placeholder="部门名称 / Name" value="<?php echo $lst['bn_name']; ?>" >
                                    </div>
                                </div>
                                <div class="am-form-group">
                                    <label for="user-name" class="am-u-sm-3 am-form-label">主管号/ ID</label>
                                    <div class="am-u-sm-9">
                                        <input type="text" id="user-name"name="gl_id" placeholder="管理员ID / ID" value="<?php echo $lst['gl_id']; ?>" >
                                    </div>
                                </div>
                                <div class="am-form-group">
                                    <label for="user-phone" class="am-u-sm-3 am-form-label">部门电话 / Telephone</label>
                                    <div class="am-u-sm-9">
                                        <input type="tel"  name="bn_phone"  placeholder="输入你的电话号码 / Telephone" value="<?php echo $lst['bn_phone']; ?>" >
                                    </div>
                                </div>
                                <div class="am-form-group">
                                   <label for="user-weibo" class="am-u-sm-3 am-form-label">备注 / Note</label>
                                    <div class="am-u-sm-9">
                                        <textarea class="" rows="5" id="user-intro" name="bn_note"  placeholder="输入你的备注 /  Note"><?php echo $lst['bn_note']; ?></textarea>
